...
import Controller.DoctorOperator;

public class vAddADoctor extends JFrame implements ActionListener
{
...
public vAddADoctor()
 {
	...
	mail=	this.jtemail.getText().matches("[a-zA-Z0-9\\.]+@[a-zA-Z0-9\\-\\_\\.]+\\.[a-zA-Z0-9]{3}");
			...
			if(c1==0&&mail==true)
			{
				new DoctorOperator().AddDoctor(jtname.getText(),jtreg.getText(),jtcontact.getText(), jtemail.getText(),bx.getSelectedItem().toString());
			}
		}
